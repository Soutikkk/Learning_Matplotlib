...
plt.tick_params(axis="both", which="both", direction="in", length=6, width=2, colors="black", grid_color="gray", grid_alpha=0.5)
plt.xticks(x, ["2023", "2024", "2025", "2026"], rotation=45, fontsize=8, fontweight="bold", color="blue")
